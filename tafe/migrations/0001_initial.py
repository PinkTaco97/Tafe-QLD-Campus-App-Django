    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=255)),
                ('image', models.CharField(blank=True, max_length=255)),
                ('link1Title', models.CharField(blank=True, max_length=255)),
                ('link1URL', models.CharField(blank=True, max_length=255)),
                ('link2Title', models.CharField(blank=True, max_length=255)),
                ('link2URL', models.CharField(blank=True, max_length=255)),
                ('listed', models.BooleanField(default=True)),
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tafe.campus')),
                ('hours', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='tafe.facilityhours')),
            ],
        ),
        migrations.AddField(
            model_name='campus',
            name='hours',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='tafe.campushours'),
        ),
        migrations.AddField(
            model_name='campus',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tafe.region'),
        ),
    ]
